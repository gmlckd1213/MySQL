...
-- 원하는 열을 원하는 순서로 나열
SELECT emp_name, emp_id, gender, phone, email, salary
	FROM employee;
...
SELECT emp_id, dept_id, gender, email
FROM employee
...
SELECT CONCAT(emp_name, '(', emp_id, ')') AS emp_name, gender, dept_id
FROM employee;
...
SELECT CONCAT(emp_name, '(', emp_id, ')') AS emp_name,
    ...
    WHERE dept_id IN ('SYS', 'MKT', 'HRD')
		AND hire_date BETWEEN '2013-01-01' AND '2015-12-31';
